        ...
        function ride($pickup, $drop,$cabtype, $luggage, $distance, $final_fare, $con){
            ...
            if(isset($_POST['submit']) && !isset($_SESSION['user'])){
                ...
                if (isset($_POST['submit'])) {
                    ...
                    $insertquery = "INSERT INTO tbl_ride (ride_date, pick_place, drop_place, total_distance, luggage, total_fare, status, customer_user_id) 
                            VALUES (NOW(), '$pickup', '$drop', '$distance', '$luggage', '$final_fare', 1, '$customer_user_id' )";
